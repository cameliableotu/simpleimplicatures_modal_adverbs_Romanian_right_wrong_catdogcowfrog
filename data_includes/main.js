...
PennController("experiment" ,
	    defaultText
	        .print(),
	       newText ("<p> Hai să trecem acum la grupul câinilor. </p>")
	    ,
...
PennController( "final" ,
    newText("<p> Mulţumesc pentru participare! Codul chestionarului pentru MTurk este: mb5t10b. Te rog fă copy-paste acestui cod în MTurk!</p>") 
	       .print()
	       ,
